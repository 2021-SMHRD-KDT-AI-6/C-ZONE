...
<!--   <form action="씨패스/수정.do" method = "post">  -->
  ...
  <hr class="profile_hr"/>
    ...
    <div class="fix_menu_1">
      ...
      <input class="pic_fix_input" type="file" name="pic_fix_input"></input>
    </div>
  </div>
  <div class="fix_menu">
    <div class="fix_menu_2">
      <div class="nickname_fix">닉네임 수정</div>
      <input class="nickname_fix_input" type="text" name="nickname_fix_input" maxlength="10" placeholder="nickname"></input>
    </div>
  </div>

<!-- </form> -->
  <hr class="profile_hr"/>
  <button class="fix_Btn">적용</button>
  </div>
</div>
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
